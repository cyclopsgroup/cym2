...
public class XmlTool {
   ...
   */
  public Document parseFile(String filePath) throws DocumentException {
   ...
   */
  public Document parseUrl(String urlString) throws DocumentException, MalformedURLException {
